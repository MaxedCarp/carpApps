...
local recid = multishell.launch({shell = shell, multishell = multishell}, "receiver")
multishell.setTitle(recid, "Unread MSG's: 0")
local usl = multishell.launch({shell = shell, multishell = multishell}, "userList.lua")
multishell.setTitle(usl, "User List")
while true do
    carpApps.Send()
end
